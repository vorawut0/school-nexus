  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden flex justify-end">
      ...
      <div className="relative w-full max-w-[560px] bg-white h-full shadow-2xl flex flex-col z-10 border-l border-slate-200/80 animate-slideInRight duration-300">
        ...
        {/* Top Header Bar */}
        <div className={`p-4 sm:p-5 border-b border-slate-200 flex flex-col gap-3 ${roleConfig.headerBg}`}>
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className={`w-11 h-11 rounded-2xl ${roleConfig.iconGradient} text-white flex items-center justify-center shadow-sm relative`}>
              ...
              <div>
                <div className="flex items-center gap-1.5">
                  <h2 className="font-bold text-[17px] text-slate-900">{roleConfig.title}</h2>
            ...
            <div className="flex items-center gap-1">
              <button
                ...
                className="w-8 h-8 rounded-lg text-slate-400 hover:text-rose-600 hover:bg-rose-50 flex items-center justify-center transition-colors text-[16px] cursor-pointer"
              ...
              <button
                onClick={onClose}
                className="w-9 h-9 rounded-xl bg-slate-100 text-slate-600 hover:bg-slate-200 flex items-center justify-center transition-colors active:scale-95 cursor-pointer"
          ...
          {user.role === 'student' && (
            <div className="flex items-center gap-2">
              <label htmlFor="course-select" className="text-[12px] font-bold text-slate-700 shrink-0 flex items-center gap-1">
              ...
              <select
                ...
                className="flex-1 text-[12px] font-semibold bg-white border border-slate-200 rounded-xl px-2.5 py-1.5 text-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-600/20 focus:border-blue-600 cursor-pointer truncate shadow-2xs"
              >
          ...
          {user.role === 'admin' && (
            <div className="flex items-center justify-between bg-white/80 p-2 rounded-xl border border-slate-200 text-xs text-slate-700">
              <span className="flex items-center gap-1.5">
                <span className="w-2 h-2 rounded-full bg-emerald-500 animate-ping" />
                <span>Scope: <strong>Smart Campus Infrastructure & Security</strong></span>
              </span>
              <span className="font-mono text-slate-900 font-bold text-[11px]">12 Nodes Active</span>
            </div>
          )}
          ...
          {user.role === 'student' && currentCourse && (
            <div
              className="px-3 py-2 rounded-xl text-white text-[12px] flex items-center justify-between shadow-2xs transition-all"
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-5 flex flex-col gap-4 bg-slate-50/50">
            ...
            return (
              ...
              >
                {!isUser ? (
                  ...
                  <div className="w-8 h-8 rounded-xl bg-slate-900 text-white flex items-center justify-center shrink-0 shadow-xs mt-1 text-[12px] font-bold">
                    {user.name.charAt(0)}
                  </div>
                )}
                  ...
                  {!isUser && (
                    <div className="flex items-center gap-2 pl-1 text-[11px] text-slate-500">
                      ...
                      <button
                        ...
                        className="hover:text-blue-700 flex items-center gap-0.5 cursor-pointer"
                        title="คัดลอกคำตอบ"
                      >
                      ...
                      <button
                        ...
                        className={`hover:text-blue-700 flex items-center gap-0.5 cursor-pointer ${
                          isSpeaking === msg.id ? 'text-blue-700 font-bold' : ''
                        }`}
                        title="อ่านออกเสียง"
                      >
                        <span className="material-symbols-outlined text-[13px]">
          ...
          {loading && (
            <div className="flex items-center gap-3 mr-auto max-w-[85%]">
              ...
              <div className="p-3.5 rounded-2xl bg-white border border-slate-200 text-[13px] text-blue-700 font-medium flex items-center gap-2 shadow-xs">
          ...
          <div className="flex gap-2 overflow-x-auto pb-1 no-scrollbar">
            {quickPrompts.map((item, idx) => (
              <button
                ...
                disabled={loading}
                className="shrink-0 px-3 py-1.5 rounded-xl bg-white hover:bg-slate-100 hover:text-slate-900 border border-slate-200 text-[12px] font-medium text-slate-700 transition-all shadow-2xs active:scale-95 disabled:opacity-50 cursor-pointer"
              >
                {item.label}
              </button>
            ))}
        ...
        <div className="p-4 border-t border-slate-200 bg-white">
          ...
          >
            <div className="relative flex-1">
              <input
                ...
                disabled={loading}
                className="w-full h-12 pl-4 pr-10 rounded-xl bg-slate-50 border border-slate-200 text-[14px] text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-600/20 transition-all disabled:opacity-60"
              />
              {inputQuery && (
                <button
                  type="button"
            ...
            <button
              ...
              className="w-12 h-12 rounded-xl bg-slate-900 hover:bg-slate-800 disabled:bg-slate-200 disabled:text-slate-400 text-white flex items-center justify-center shadow-sm transition-all active:scale-95 shrink-0 cursor-pointer"
              title="ส่งข้อความ"
            >
          ...
          <p className="text-[10px] text-center text-slate-400 mt-2">
            ระบบความช่วยเหลือการเรียนรู้และการสอนอัจฉริยะ • ปลอดภัยและเฉพาะเจาะจงตามบทบาท
          </p>
        </div>
      </div>
    </div>
