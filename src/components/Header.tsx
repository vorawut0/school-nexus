      ...
      <div className="w-full max-w-[1280px] mx-auto h-14 sm:h-16 flex items-center justify-between px-3 sm:px-6 gap-2">
        ...
        <div className="flex items-center gap-1 sm:gap-2 shrink-0">
          <button
            ...
            className="w-8 h-8 sm:w-9 sm:h-9 rounded-xl flex items-center justify-center text-slate-600 hover:text-blue-700 hover:bg-slate-100 active:scale-95 transition-all shrink-0 cursor-pointer"
            title="ค้นหา"
            aria-label="Search"
          >
          ...
          <button
            ...
            className="w-8 h-8 sm:w-9 sm:h-9 rounded-xl flex items-center justify-center text-slate-600 hover:text-blue-700 hover:bg-slate-100 active:scale-95 transition-all relative shrink-0 cursor-pointer"
            title="การแจ้งเตือน"
            aria-label="Notifications"
          >
            <span className="material-symbols-outlined text-[20px] sm:text-[22px]">notifications</span>
            {unreadNotificationsCount > 0 && (
              <span className="absolute top-1.5 right-1.5 w-2 sm:w-2.5 h-2 sm:h-2.5 bg-rose-600 rounded-full ring-2 ring-white animate-pulse" />
            )}
          </button>
          ...
          >
            <img
              ...
              alt={user.name}
              className="w-8 h-8 sm:w-9 sm:h-9 rounded-full object-cover ring-2 ring-slate-200 shadow-sm hover:ring-blue-600 transition-all"
            />
