        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="text-[#1550d3] text-[13px] font-semibold flex items-center gap-1.5 hover:bg-blue-50 bg-white px-3.5 py-2 rounded-2xl border border-slate-200 shadow-xs active:scale-95 transition-all cursor-pointer"
            >
            ...
            <button
              ...
              className="bg-[#1550d3] hover:bg-[#1a53d6] text-white text-[13px] font-bold flex items-center gap-1.5 px-4 py-2 rounded-2xl shadow-md active:scale-95 transition-all cursor-pointer"
            >
