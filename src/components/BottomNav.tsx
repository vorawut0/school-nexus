...
export const BottomNav: React.FC<BottomNavProps> = ({
  ...
  return (
    <nav className="fixed bottom-0 inset-x-0 z-40 w-full bg-white/95 backdrop-blur-xl border-t border-[#e8ecf3] shadow-[0_-4px_20px_rgba(23,32,51,0.04)] pb-safe">
          ...
          return (
            <button
              ...
              className={`flex flex-col items-center justify-center gap-1 w-14 sm:w-16 h-14 rounded-xl transition-all duration-200 relative cursor-pointer ${
                isActive
                  ? 'text-blue-700 bg-blue-50 font-bold scale-105 shadow-2xs'
                  : 'text-slate-600 hover:text-blue-700 hover:bg-slate-100/80 active:scale-95'
              }`}
            >
