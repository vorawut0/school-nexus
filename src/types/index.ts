...
export interface QuizQuestion {
  ...
  explanation: string;
  relatedFormulaOrTip?: string;
  points: number;
}

export interface QuizMockSet {
  id: string;
  title: string;
  courseId: string;
  courseCode: string;
  ...
  category: 'unit_test' | 'midterm_prep' | 'final_exam' | 'code_drill';
...
export interface QuizUserAttempt {
  ...
  flags: Record<string, boolean>; // questionId -> flaggedForReview
  score: number;
  totalPoints: number;
